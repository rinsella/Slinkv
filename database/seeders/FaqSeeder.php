...
class FaqSeeder extends Seeder
{
    public function run(): void
    {
        $faqs = [
            ...
            ['Apakah SlinkV gratis?', 'Ya. Selama masa beta, semua fitur SlinkV tersedia 100% gratis untuk semua pengguna, termasuk unlimited link, analytics lengkap, bot protection advanced, custom alias, fallback URL, geo filter, device tracking, export data, dan QR code.'],
            ...
            ['Apakah bisa filter negara?', 'Selama beta, geo filter tersedia gratis untuk semua pengguna. Setelah beta, batas fitur akan mengikuti paket yang aktif.'],
